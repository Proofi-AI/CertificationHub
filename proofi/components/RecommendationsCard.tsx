  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-xs font-bold uppercase tracking-[0.1em] text-slate-500 dark:text-white/50 flex-1">
                ...
                <div key={i} className="px-5 py-4 flex flex-col gap-2">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="w-5 h-5 rounded-md flex items-center justify-center shrink-0 mt-0.5"
                      ...
                      <span className="text-[10px] font-black text-slate-400 dark:text-white/35">{i + 1}</span>
                    </div>
                    {/* Name + badges */}
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-bold text-slate-900 dark:text-white leading-snug">{rec.name}</p>
                      <p className="text-[12px] text-slate-500 dark:text-white/50 mt-0.5 truncate">{rec.issuer}</p>
                    </div>
                  </div>
                  ...
                  {/* Reason */}
                  <p className="text-[12px] text-slate-500 dark:text-white/45 leading-relaxed ml-8">{rec.reason}</p>
                </div>
              );
            })}
          </div>
