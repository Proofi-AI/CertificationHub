...
type SortOption = "recent" | "oldest" | "alphabetical" | "organization";
...
export default function BadgesPanel({ initialBadges, onBadgesChange }: Props) {
  ...
  // Load custom organizations on mount
  useEffect(() => {
        ...
        <div className="relative rounded-3xl overflow-hidden p-8 sm:p-16 text-center" style={{ background: "var(--surface)", border: "1px solid var(--border)" }}>
          ...
          <div className="relative">
            <div
              ...
              style={{ background: "linear-gradient(135deg, rgba(124,58,237,0.2), rgba(79,70,229,0.08))", border: "1px solid rgba(124,58,237,0.22)", boxShadow: "0 0 48px rgba(124,58,237,0.15)" }}
            >
