  ...
  return (
    ...
    <div className={`relative rounded-2xl border border-white/8 bg-gradient-to-br ${grad} overflow-hidden group hover:border-white/15 transition-all`}>
      ...
      {certificate.imageUrl && (
        ...
        >
          {isPdf ? (
            <div className="h-full flex flex-col items-center justify-center gap-2 bg-red-500/8 hover:bg-red-500/12 transition-colors">
              ...
              <span className="text-xs text-white/40">PDF · click to view</span>
            </div>
          ) : (
            <>
